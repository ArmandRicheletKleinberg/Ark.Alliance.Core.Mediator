...
project by **Richard Lander** and contributors. Many thanks to **Armand
Richelet‑Kleinberg** for the integration guide.

## SDLC
The directory documents our full Software Development Life Cycle (planning, design, implementation, testing, deployment and maintenance).
