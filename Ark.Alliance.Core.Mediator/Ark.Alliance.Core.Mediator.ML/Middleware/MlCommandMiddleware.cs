...
/// <summary>
/// Captures command payloads for ML training and enqueues them for ingestion.
/// </summary>
public sealed class MlCommandMiddleware<TCommand, TResult> : ICommandMiddleware<TCommand, TResult>
    where TCommand : ICommand<TResult>
{
    ...
    /// <summary>
    /// Creates a new instance with options and queue writer.
    /// </summary>
    public MlCommandMiddleware(MlTelemetryOptions options, Channel<byte[]> queue)
    {
        _options = options;
